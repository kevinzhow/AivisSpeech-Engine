"""AIVM/Safetensors GGUF cache tests."""
...
from voicevox_engine.aivm_gguf_cache import AivmGgufCache, AivmGgufCacheError
...
def test_aivm_gguf_cache_converts_safetensors_model(
    ...
    assert (
        ...
        == "tts-cpp-style-bert-vits2-converter-v1"
    )
...
def test_aivm_gguf_cache_rejects_onnx_metadata(tmp_path: Path) -> None:
    ...
    with pytest.raises(AivmGgufCacheError, match="AIVM/Safetensors"):
        cache.ensure(
